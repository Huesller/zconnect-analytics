...
7. Confirme que as sete etapas do **Funil** cabem na tela e teste a navegação por etapa.
8. Em **Carrinhos**, confira as abas de ativos, histórico e clientes que precisam de contato; copie a mensagem de WhatsApp.
9. Na área **Qualidade**, teste a mesclagem manual com uma duplicidade conhecida e valide a exclusão seletiva por tipo de dado.
10. Abra **Produtos** e alterne as quatro leituras.
