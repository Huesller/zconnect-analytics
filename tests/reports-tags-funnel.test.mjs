...
test("tags comerciais são fixas, múltiplas e filtráveis", () => {
  for (const tag of ["Venda sob encomenda", "Cliente potencial", "Cliente bloqueado", "Linha mecânica", "Compra recorrente", "Cliente em reativação"]) assert.match(source, new RegExp(tag));
